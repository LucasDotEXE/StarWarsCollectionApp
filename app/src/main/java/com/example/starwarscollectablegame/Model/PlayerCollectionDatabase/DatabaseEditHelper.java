package com.example.starwarscollectablegame.Model.PlayerCollectionDatabase;

import android.os.AsyncTask;

import com.example.starwarscollectablegame.Model.PlayerCollectionDatabase.DaoInterfaces.BaseCollectionDao;
import com.example.starwarscollectablegame.Model.PlayerCollectionDatabase.PlayerCollectionDatabaseData.ewa;
...
public class DatabaseEditHelper<T extends ewa> {
    ...
    public void insert(T item) {
        new com.example.starwarscollectablegame.Model.PlayerCollectionDatabase.DatabaseEditHelper.InsertAsyncTask<T>(this.dao).execute(item);
    }

    public void update(T item) {
        new com.example.starwarscollectablegame.Model.PlayerCollectionDatabase.DatabaseEditHelper.UpdateAsyncTask<T>(this.dao).execute(item);
    }

    public void delete(T item) {
        new com.example.starwarscollectablegame.Model.PlayerCollectionDatabase.DatabaseEditHelper.DeleteAsyncTask<T>(this.dao).execute(item);
    }
